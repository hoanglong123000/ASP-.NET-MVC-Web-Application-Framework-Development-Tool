...
namespace Service.Education.Executes.Base
{
    ...
    {
        public QueryResult<ClothViewModel> ClothMany(SearchClothModel model, OptionResult optionResult)
        {
            /*if (model.Cache)
            {*/
                ...
                return data;*/
           /* }*/
            return ClothData(model, optionResult);
        }

        private QueryResult<ClothViewModel> ClothData(SearchClothModel model, OptionResult optionResult)
        {
            CheckDbConnect();
            IQueryable<Cloth> q = Context.Clothes.Where(x => x.Status >= 0);
            ...
            #region READ Clothes LIST.
            var r = q.Select(x => new ClothViewModel
            {
                Id = x.Id,
                Status = x.Status,
            ...
            var result = new QueryResult<ClothViewModel>(r, optionResult);
