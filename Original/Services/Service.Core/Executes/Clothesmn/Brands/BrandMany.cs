...
namespace Service.Education.Executes.Base
{
    ...
    {
        public QueryResult<BrandViewModel> BrandMany(SearchBrandModel model, OptionResult optionResult)
        {
            /*if (model.Cache)
            {*/
                ...
                return data;*/
           /* }*/
            return BrandData(model, optionResult);
        }

        private QueryResult<BrandViewModel> BrandData(SearchBrandModel model, OptionResult optionResult)
        {
            CheckDbConnect();
            ...
            var r = q.Select(x => new BrandViewModel
            {
                Id = x.Id,
                Status = x.Status,
            ...
            var result = new QueryResult<BrandViewModel>(r, optionResult);
